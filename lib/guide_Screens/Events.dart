            ...
            child: Column(
              ...
              children: <Widget>[
                ListTile(
                  leading: const Icon(
                    Icons.add_box,
                    color: Color.fromARGB(255, 93, 6, 94),
                  ),
                ...
                ListTile(
                  leading: const Icon(
                    Icons.delete,
                    color: Color.fromARGB(255, 241, 22, 18),
                  ),
                ...
                ListTile(
                  leading: const Icon(
                    Icons.edit,
                    color: Color.fromARGB(255, 11, 14, 215),
                  ),
            ...
            child: SingleChildScrollView(
              child: Container(
                ...
                child: SfCalendar(
                  ...
                  dataSource:
                      EventCalendarDataSource(_getCalendarAppointments()),
      ...
      case FilterType.All:
        ...
        for (var activity in activities) {
          appointments.add(Appointment(
            ...
            subject: 'Activity: ${activity.agency}',
