...
import 'package:SunShine/features/profile/data/datasourses/user_local_data_sources.dart';
import 'package:SunShine/features/profile/data/datasourses/user_remote_data_sources.dart';
...
class UserRepositoryImpl implements UserRepository {
  ...
  Future<Either<Failure, User>> getAllUser(String? index) async {
    if (await networkInfo.isConnectes) {
      try {
        final RemoteNotificationList = await userRemoteDataSours.getUser(index);
        await userLocalDataSours.cachedNotification(RemoteNotificationList);
      ...
      try {
        final CachedNotificationList = await userLocalDataSours.getCachedUser();
