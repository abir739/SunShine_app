...
class PushNotificationGuideScreen extends StatefulWidget {
  ...
  @override
  _PushNotificationGuideScreenState createState() => _PushNotificationGuideScreenState();
}

class _PushNotificationGuideScreenState extends State<PushNotificationGuideScreen> {
              ...
              builder: (BuildContext context) {
                return AlertDialog(
                  ...
                  content: Container(
                    ...
                    child: Column(children: [Text('Rsend again'),],),
                  ),
                  actions: <Widget>[
                    TextButton(
                      onPressed: () {
          ...
          children: [
            Card(
                ...
                shape: RoundedRectangleBorder(
                  side:  BorderSide(color: settingsProvider.isDarkMode
