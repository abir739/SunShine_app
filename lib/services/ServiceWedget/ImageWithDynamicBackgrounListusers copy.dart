...
class ImageWithDynamicBackgroundColorusersList extends StatefulWidget {
  ...
  ImageWithDynamicBackgroundColorusersList({required this.color,required this.imageUrl,required this.isCirculair});
...
class _ImageWithDynamicBackgroundColorusersListState
  ...
  Widget build(BuildContext context) {
    return
    widget.isCirculair? Container(width: 50,height: 50,
