...
import 'package:SunShine/Secreens/Notification/notificationlist_Travellers.dart';
...
import 'package:SunShine/traveller_Screens/Contact_guide.dart';
import 'package:SunShine/traveller_Screens/Traveller_Profil/profile_By_Code_test.dart';
  ...
  void _onItemTapped(int index) {
    ...
    setState(() {
      ...
      if (index == 0) {
        ...
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => NotificationScreen(
                groupsid: widget.selectedTraveller.touristGroupId),
          ),
        );
      } else if (index == 2) {
        ...
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => TouristGuideProfilePage(
              traveller:
                  widget.selectedTraveller, // Pass the Traveller object here
            ),
          ),
        );
      } else if (index == 3) {
